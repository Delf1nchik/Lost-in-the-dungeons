...
- Space - смена оружия.
- Shift-первая способность персонажа( после убийства 1 босса)
- E- вторая способность персонажа (после убийства 2 босса)
**План на игру**
- Найти ключ для прохода к боссу,дверь босса находится в начальной комнате(нажмите F для прохода), победив босса вы получите осколок памяти( способность) и можете пройти на новый уровень.
--------------------------------------------
...
- Стены, дверь,пол- https://rgsdev.itch.io/free-cc0-top-down-tileset-template-pixel-art
